 ...
 */
public class FamilyEventFragment extends Fragment implements EventsPresenter, EventsAdapter.RowClick {
    ...
    private void getEventData(){
        ...
        eventsData.getEventsByCategory(Constants.FAMILY_CATEGORY);
    }
